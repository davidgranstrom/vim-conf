...
function s:insert_float() abort
  call nvim_feedkeys(luaeval('require"random".float()'), 'i', v:true)
endfunction

function s:insert_int() abort
  call nvim_feedkeys(luaeval('require"random".int()'), 'i', v:true)
endfunction
...
function s:set_int_range(...) abort
  call luaeval('require"random".set_int_range(unpack(_A))', a:000)
endfunction

function s:set_float_range(...) abort
  call luaeval('require"random".set_float_range(unpack(_A))', a:000)
endfunction
